...
Welcome to Part 2 of the "Blog-as-Code" series. As a recap in the [previous post](2024-01-13-Blog-as-Code-Part1.md), we got the foundation of our site up and running with a bit of our personal flavour applied.
...
Now before we dive into the process for drafting and then publishing a post. I wanted to expand on the tooling (IDE) I mentioned in Part 1. So for the most part I use [VSCode for Web](www.vscode.dev) to work with my GitHub repo / projects. And to help make things even easier I also use / recommend the following Extensions:
